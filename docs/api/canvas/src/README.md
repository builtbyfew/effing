...
[Effing API Reference](../../README.md) / canvas/src
...
- [registerFontFromPath](functions/registerFontFromPath.md)
- [renderLottieFrame](functions/renderLottieFrame.md)
- [renderReactElement](functions/renderReactElement.md)
