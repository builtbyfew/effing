...
- **For the full format vocabulary** — layer types, transitions, effects, source `#refs`, backgrounds, motion, validation — see `node_modules/@effing/effie/README.md`. This README only covers the very basics.
