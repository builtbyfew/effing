...
- @effing/fn@0.41.2
- @effing/serde@0.41.2
- @effing/annie-player@0.41.2
- @effing/effie-preview@0.41.2
...
- @effing/fn@0.41.1
- @effing/serde@0.41.1
- @effing/annie-player@0.41.1
- @effing/effie-preview@0.41.1

## 0.41.0

### Patch Changes

- Updated dependencies [ce15abd]
  - @effing/effie@0.41.0
  - @effing/effie-preview@0.41.0
  - @effing/fn@0.41.0
  - @effing/serde@0.41.0
  - @effing/annie-player@0.41.0

## 0.40.2

### Patch Changes

- @effing/effie-preview@0.40.2
- @effing/effie@0.40.2
- @effing/fn@0.40.2
- @effing/serde@0.40.2
- @effing/annie-player@0.40.2

## 0.40.1

### Patch Changes

- 9c9b28a: Security dependency upgrades: vite 7.3.6, react-router 7.18.2, esbuild 0.28.2
  ...
  - @effing/effie-preview@0.40.1
  - @effing/effie@0.40.1
  - @effing/fn@0.40.1
  - @effing/serde@0.40.1
  - @effing/annie-player@0.40.1

## 0.40.0

### Minor Changes

- 971e10f: Add `effing render <kind> <id>` — render an image, annie, or effie fn straight to a file without a running dev server. The command spins up an ephemeral dev server on a free loopback port, resolves the fn (its `previewProps` by default, or `--props`), and writes the artifact: PNG/JPEG for images, a TAR of frames for annies, or an MP4 for effies (delegating to the project-local `ffs render`, so effies need `@effing/ffs` installed). A missing `SECRET_KEY` is replaced by a throwaway key for the render, so no env setup is required. `effing dev` now does the same — signed URLs just don't survive a restart — leaving `effing url` and the built production server as the only places that still require a configured `SECRET_KEY`. Both `effing render` and `effing url` also accept `--resolution <label>` to pick bounds from a `dev.resolutions` preset by label, as an alternative to spelling out `--width`/`--height`.

### Patch Changes

- Updated dependencies [c0ffebf]
- Updated dependencies [fd0e0bd]
  - @effing/fn@0.40.0
  - @effing/annie-player@0.40.0
  - @effing/effie-preview@0.40.0
  - @effing/effie@0.40.0
  - @effing/serde@0.40.0
...
- Updated dependencies [d125693]
  ...
  - @effing/effie@0.39.0
  - @effing/serde@0.39.0
  - @effing/effie-preview@0.39.0
  - @effing/annie-player@0.39.0

## 0.38.4

### Patch Changes

- @effing/effie-preview@0.38.4
- @effing/effie@0.38.4
- @effing/fn@0.38.4
- @effing/serde@0.38.4
- @effing/annie-player@0.38.4

## 0.38.3

### Patch Changes

- 4c4eae6: Reload the dev preview when a non-fn helper module changes
  ...
  - @effing/fn@0.38.3
  - @effing/serde@0.38.3
  - @effing/annie-player@0.38.3
  - @effing/effie-preview@0.38.3

## 0.38.2

### Patch Changes

- @effing/effie-preview@0.38.2
- @effing/effie@0.38.2
- @effing/fn@0.38.2
- @effing/serde@0.38.2
- @effing/annie-player@0.38.2

## 0.38.1

### Patch Changes

- @effing/effie-preview@0.38.1
- @effing/effie@0.38.1
- @effing/fn@0.38.1
- @effing/serde@0.38.1
- @effing/annie-player@0.38.1
